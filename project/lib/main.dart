...
import 'package:project/spash_screen/spash_screen_widget.dart';
import 'flutter_flow/flutter_flow_theme.dart';
import 'list_products/list_products_widget.dart';
...
class _NavBarPageState extends State<NavBarPage> {
  String _currentPage = 'ListProducts';
  ...
  Widget build(BuildContext context) {
    final tabs = {
      'ListProducts': ListProductsWidget(),
      'Profil': ProfilWidget(),
      'Cart': CartWidget(),
    };
    return Scaffold(
